...
urlpatterns = [
    ...
    url(r'^(?P<order_pk>\d+)/payment/update/$', #(?P<payment_pk>\d+)
        views.update_payments, name='update-payments'),

    url(r'^(?P<order_pk>\d+)/suborder/(?P<suborder_pk>\d+)/update/$',
        views.update_suborder, name='update-suborder'),
